EMACS ?= emacs
LOAD_PATH = -L . -L test
SOURCES = herdr-protocol.el herdr-model.el herdr-events.el herdr.el agent-fleet.el agent-fleet-display.el agent-fleet-worktree.el agent-fleet-project.el agent-fleet-magit.el agent-fleet-parallel.el agent-fleet-attach.el agent-fleet-dashboard.el
